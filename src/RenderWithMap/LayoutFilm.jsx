...
export default class LayoutFilm extends Component {
    renderCard = () => {
        return data.map((film) => {
            return (
                <div className="col-lg-2 col-md-3 mt-2" key={film.maPhim}>
                    <div className="card">
                        <img src={film.hinhAnh} alt="..." className="card-img-top" style={{height: "350px"}}/>
                        <div className="card-body bg-dark text-white">
                            <h3 className="card-title" style={{height: "75px"}}>{film.tenPhim}</h3>
                            <p className="card-text" style={{height: "80px"} }>{film.moTa.length > 100 ? film.moTa.slice(0,100) + "..." : film.moTa}</p>
                        </div>
                    </div>
                </div>
            );
        ...
        return (
            <div className="bg-film">
                <div style={{ backgroundColor: "rgba(0,0,0,0.5)", minHeight: "100vh" }}>
                    <nav className="navbar navbar-expand-sm navbar-dark" style={{ backgroundColor: "rgba(255,0,255,0.2)" }}>
